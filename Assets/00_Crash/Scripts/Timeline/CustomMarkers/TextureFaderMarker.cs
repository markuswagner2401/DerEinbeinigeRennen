...
namespace ObliqueSenastions.TimelineSpace
{
    ...
    public class TextureFaderMarker : Marker, INotification, INotificationOptionProvider, IMarker
    {
        [SerializeField] string note = "";

        [SerializeField] int textureChangerIndex = 0;
        ...
        public int TextureChangerIndex() { return textureChangerIndex; }
