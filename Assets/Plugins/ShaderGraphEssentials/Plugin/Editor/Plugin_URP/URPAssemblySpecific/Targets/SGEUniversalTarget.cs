...
#region Passes
    static class CorePasses
    {
        ...
        internal static void AddTargetSurfaceControlsToPass(ref PassDescriptor pass, SGEUniversalTarget target)
        {
...
#region RenderStates
    static class CoreRenderStates
    {
        ...
        // used by lit/unlit subtargets
        public static RenderStateCollection UberSwitchedRenderState(SGEUniversalTarget target)
        {
